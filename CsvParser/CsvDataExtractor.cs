...
namespace CsvParser
{
    [Obsolete("This class is obsolete and soon will be deleted. Please, use CsvParser.CsvObjectParser instead.")]
    public class CsvDataExtractor
    {
        [Obsolete("This method is obsolete and soon will be deleted. Please, use CsvParser.CsvObjectParser.Parse")]
        ...
        {
            if (options.ShouldSkipEqualObject is false)
            {
